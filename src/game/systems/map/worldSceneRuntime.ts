...
function getFallbackPlayerSpawnPosition(options: {
...
function findNearestWalkableSpawnPosition(options: {
  mapWidth: number;
  mapHeight: number;
  collisionRuntime: Pick<
    ReturnType<typeof createCollisionRuntime>,
    'isTileInBounds' | 'isTileWalkable' | 'getTileCenterWorldPosition'
  >;
}): WorldPosition | null {
