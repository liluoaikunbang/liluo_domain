...
7. Run only the validators directly affected by the synchronized records (`docs:governance:audit` when IDs/catalog/records changed). Do not probe a documented script known to be absent, and do not run a Web build for documentation-only changes.
