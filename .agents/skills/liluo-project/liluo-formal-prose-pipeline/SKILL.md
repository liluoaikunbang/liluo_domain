...
4. Expression references must be explicit, user-confirmed material from the relevant RAG card’s expression branch or a named writing sample. Do not run automatic style retrieval or create Style Pack entries.
